...
function adrotate_database_install() {
	...
	if(!$wpdb->get_var("SHOW TABLES LIKE '".$tables['adrotate_stats']."'")) { // wp_adrotate_stats
		$sql = "CREATE TABLE `".$tables['adrotate_stats']."` (
...
function adrotate_list_tables() {
	...
	$tables = array(
		...
		'adrotate_stats_cache'		=> $wpdb->prefix . "adrotate_stats_cache",		// Since 3.8
	);
