				...
				if($page_output['location'] == 4 AND is_page($page_output['pages'])) {
					...
					foreach($paragraphs as $paragraph) {
						if(($par == $page_output['paragraph']
						  ...
						  OR ($par == 4 AND $page_output['paragraph'] == 40)) AND $adcount > 0) {
...
function adrotate_custom_scripts() {
	...
	if($adrotate_config['jshowoff'] == 'Y') wp_enqueue_script('jshowoff-adrotate', plugins_url('/library/jquery.adrotate.dyngroup.js', __FILE__), false, '0.5.2', $in_footer);
