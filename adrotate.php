...
define("ADROTATE_DISPLAY", '3.9'.ADROTATE_BETA);
define("ADROTATE_VERSION", 369);
define("ADROTATE_DB_VERSION", 38);
...
if(isset($_POST['adrotate_stat_cleanup_submit'])) 		add_action('init', 'adrotate_cleanup_statistics');
	...
	<div class="wrap">
		...
		<?php } ?>
	  	...
	  	<form name="settings" id="post" method="post" action="admin.php?page=adrotate-settings">
			...
			<tr>
				<th valign="top"><?php _e('Clean-up Stats', 'adrotate'); ?></th>
				<td>
					<input type="submit" id="post-role-submit" name="adrotate_stat_cleanup_submit" value="<?php _e('Clean-up Statistics', 'adrotate'); ?>" class="button-secondary" onclick="return confirm('<?php _e('You are about to remove statistics older than 356 days from the AdRotate database.', 'adrotate'); ?>\n\n<?php _e('This action can not be undone!', 'adrotate'); ?>\n\n<?php _e('OK to continue, CANCEL to stop.', 'adrotate'); ?>')" /><br />
					<span class="description"><?php _e('Delete statistics older than 356 days in order to keep your database clean. This may improve the speed of your site.', 'adrotate'); ?></span>
				</td>
			</tr>
			<tr>
