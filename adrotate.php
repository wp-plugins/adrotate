...
define("ADROTATE_DISPLAY", '3.8.6'.ADROTATE_BETA);
		...
		<?php } ?>
	  	...
	  	<form name="settings" id="post" method="post" action="admin.php?page=adrotate-settings">
			...
			<tr>
				...
				<td><input type="checkbox" name="adrotate_jquery" <?php if($adrotate_config['jquery'] == 'Y') { ?>checked="checked" <?php } ?> /> <span class="description"><?php _e('Check this box if your theme does not add jQuery to your site. This option may be required for Dynamic Mode in Groups.', 'adrotate'); ?></span></td>
			</tr>
