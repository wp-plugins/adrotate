...
/*--- AdRotate values ---------------------------------------*/
define("ADROTATE_DISPLAY", '3.9.14');
define("ADROTATE_VERSION", 372);
...
function adrotate_server() {
	...
	<div class="wrap">
		...
		<?php if($wpdb->get_var("SHOW TABLES LIKE '".$wpdb->prefix."adrotate';") AND $wpdb->get_var("SHOW TABLES LIKE '".$wpdb->prefix."adrotate_groups';") AND $wpdb->get_var("SHOW TABLES LIKE '".$wpdb->prefix."adrotate_schedule';") AND $wpdb->get_var("SHOW TABLES LIKE '".$wpdb->prefix."adrotate_linkmeta';")) { ?>
			...
			<p>NOTICE: <?php _e('AdRotate server is currently in development and these menus are not functional yet.', 'adrotate'); ?></p>
	  	...
	  	<form name="settings" id="post" method="post" action="admin.php?page=adrotate-settings">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<span class="description"><?php _e('Default: 10. Set to 1 to disable this timer.', 'adrotate'); ?><br /><?php _e('This number may not be empty, negative or exceed 3600 (1 hour).', 'adrotate'); ?></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<span class="description"><?php _e('Default: 86400. Set to 1 to disable this timer.', 'adrotate'); ?><br /><?php _e('This number may not be empty, negative or exceed 86400 (24 hours).', 'adrotate'); ?></span>
					</td>
				</tr>
			</table>
			...
			<table class="form-table">			
				...
				<tr>
					...
					<td><input type="checkbox" name="adrotate_supercache" <?php if($adrotate_config['supercache'] == 'Y') { ?>checked="checked" <?php } ?> /> <span class="description"><?php _e('Check this box if you use WP Super Cache on your site. It is reported by users that if you have version 1.4 or newer this option may not work.', 'adrotate'); ?></span></td>
				</tr>
				<tr>
					<th valign="top">&nbsp;</th>
