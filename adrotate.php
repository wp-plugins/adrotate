...
define("ADROTATE_DISPLAY", '3.8.10'.ADROTATE_BETA);
define("ADROTATE_VERSION", 369);
define("ADROTATE_DB_VERSION", 35);
	  	...
	  	<form name="settings" id="post" method="post" action="admin.php?page=adrotate-settings">
			...
			<tr>
				...
				<td>
					...
					<?php _e('Keep in mind that this might give false positives. The word \'google\' also matches \'googlebot\', so be careful!', 'adrotate'); ?>. <?php _e('Keep your list up-to-date', 'adrotate'); ?> <a href="http://www.robotstxt.org/db.html" target="_blank">robotstxt.org/db.html</a>.<br />
