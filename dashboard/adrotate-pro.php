			...
			<div id="normal-sortables" class="meta-box-sortables ui-sortable">
				...
				<div class="postbox-adrotate">
					<div class="inside">
						...
						<center><a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=upgrade_adrotatefree" target="_blank"><img src="<?php echo WP_CONTENT_URL; ?>/plugins/adrotate/images/demo-advertisers.jpg" /></a></center>
					</div>
				</div>
				...
				<div class="postbox-adrotate">
					<div class="inside">
						...
						<center><a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=upgrade_adrotatefree" target="_blank"><img src="<?php echo WP_CONTENT_URL; ?>/plugins/adrotate/images/demo-geotargetting.jpg" /></a></center>
					</div>
				</div>
			...
			<div id="side-sortables" class="meta-box-sortables ui-sortable">
				...
				<div class="postbox-adrotate">
					<div class="inside">
						...
						<center><a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=upgrade_adrotatefree" target="_blank"><img src="<?php echo WP_CONTENT_URL; ?>/plugins/adrotate/images/demo-schedules.jpg" /></a></center>
					</div>
				</div>
				...
				<div class="postbox-adrotate">
					<div class="inside">
						...
						<center><a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=upgrade_adrotatefree" target="_blank"><img src="<?php echo WP_CONTENT_URL; ?>/plugins/adrotate/images/demo-notifications.jpg" /></a></center>
					</div>
				</div>
				...
				<div class="postbox-adrotate">
					<div class="inside">
						<a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=compare_license"><img src="<?php echo WP_CONTENT_URL; ?>/plugins/adrotate/images/adrotate-product.png" alt="adrotate-product" width="150" height="150" align="right" style="padding: 0 0 10px 10px;" /></a>
						<p><h4><?php _e('Singe License', 'adrotate'); ?> (&euro; 29.00)</h4><?php _e('For one WordPress installation.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-single/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=buy_single" target="_blank"><?php _e('Buy now', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Duo License', 'adrotate'); ?> (&euro; 39.00)</h4><?php _e('For two WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-duo/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=buy_duo" target="_blank"><?php _e('Buy now', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Multi License', 'adrotate'); ?> (&euro; 99.00)</h4><?php _e(' For up to five WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-multi/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=buy_multi" target="_blank"><?php _e('Buy now', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Network License', 'adrotate'); ?> (&euro; 199.00)</h4><?php _e('Set up your own advertising network on a WordPress Multisite.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-network/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=buy_network" target="_blank"><?php _e('Buy now', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Developer License', 'adrotate'); ?> (&euro; 299.00)</h4><?php _e('Activate AdRotate on unlimited WordPress installations and/or networks.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-developer/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=buy_developer" target="_blank"><?php _e('Buy now', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Compare licenses', 'adrotate'); ?></h4> <?php _e("Not sure which license is for you? Compare them...", 'adrotate'); ?> <a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_free&utm_medium=adrotate_pro_page&utm_campaign=compare_license" target="_blank"><?php _e('All Licenses', 'adrotate'); ?> &raquo;</a></p>
					</div>
				</div>
