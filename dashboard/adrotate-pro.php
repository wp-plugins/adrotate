			...
			<div id="side-sortables" class="meta-box-sortables ui-sortable">
				...
				<div class="postbox-adrotate">
					<div class="inside">
						...
						<p><h4><?php _e('Singe License', 'adrotate'); ?> (&euro; 29.00)</h4><?php _e('For one WordPress installation.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-single/?utm_source=adrotate_pro&utm_medium=adrotate_free&utm_campaign=upgrade_adrotatefree" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Duo License', 'adrotate'); ?> (&euro; 39.00)</h4><?php _e('For two WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-duo/?utm_source=adrotate_pro&utm_medium=adrotate_free&utm_campaign=upgrade_adrotatefree" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Multi License', 'adrotate'); ?> (&euro; 99.00)</h4><?php _e(' For up to five WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-multi/?utm_source=adrotate_pro&utm_medium=adrotate_free&utm_campaign=upgrade_adrotatefree" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						...
						<p><h4><?php _e('Compare licenses', 'adrotate'); ?></h4> <?php _e("Not sure which license is for you? Compare them...", 'adrotate'); ?> <a href="https://www.adrotateplugin.com/adrotate-pro/?utm_source=adrotate_pro&utm_medium=adrotate_free&utm_campaign=upgrade_adrotatefree" target="_blank"><?php _e('All Licenses', 'adrotate'); ?> &raquo;</a></p>
					</div>
				</div>
