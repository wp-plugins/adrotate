...
<div id="dashboard-widgets-wrap">
	...
	<p><center>Take a peek into professional advertising for WordPress websites and discover how you can benefit from the powerful features <a href="https://www.adrotateplugin.com/" target="_blank">AdRotate Professional</a> has to offer.</center></p>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></center></p>
		...
		<div id="postbox-container-3" class="postbox-container" style="width:50%;">
			<div id="side-sortables" class="meta-box-sortables ui-sortable">
				...
				<div class="postbox-adrotate">
					<div class="inside">
						<p><h4><?php _e('Singe License', 'adrotate'); ?> (&euro; 29.00)</h4><?php _e('For one WordPress installation.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-single/" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Duo License', 'adrotate'); ?> (&euro; 39.00)</h4><?php _e('For two WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-duo/" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Multi License', 'adrotate'); ?> (&euro; 99.00)</h4><?php _e(' For up to five WordPress installations.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-multi/" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Network License', 'adrotate'); ?> (&euro; 199.00)</h4><?php _e('Set up your own advertising network on a WordPress Multisite.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-network/" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Developer License', 'adrotate'); ?> (&euro; 299.00)</h4><?php _e('Activate AdRotate on unlimited WordPress installations and/or networks.', 'adrotate'); ?> <a href="https://www.adrotateplugin.com/shop/adrotate-plugin/adrotate-pro-developer/" target="_blank"><?php _e('Buy', 'adrotate'); ?> &raquo;</a></p>
						<p><h4><?php _e('Compare licenses', 'adrotate'); ?></h4> <?php _e("Not sure which license is for you? Compare them...", 'adrotate'); ?> <a href="https://www.adrotateplugin.com/adrotate-pro/" target="_blank"><?php _e('All Licenses', 'adrotate'); ?> &raquo;</a></p>
					</div>
				</div>
	...
	<p><center>A grasp of the features AdRotate Pro has to offer over the free version. Check out the <a href="https://www.adrotateplugin.com/" target="_blank">AdRotate website</a> for more information.<br />All prices are in Euros and inclusive of tax/VAT in the European Union. The amount will be converted to Euros automagically.</center></p>
