...
<h3><?php _e('New group', 'adrotate'); ?></h3>
	...
	if($edit_id == 0) {
		$wpdb->insert($wpdb->prefix.'adrotate_groups', array('name' => '', 'modus' => 0, 'fallback' => '0', 'sortorder' => 0, 'cat' => '', 'cat_loc' => 0, 'page' => '', 'page_loc' => 0, 'geo' => 0, 'wrapper_before' => '', 'wrapper_after' => '', 'gridrows' => 2, 'gridcolumns' => 2, 'admargin' => 1, 'adwidth' => '125', 'adheight' => '125', 'adspeed' => 6000));
...
<form name="editgroup" id="post" method="post" action="admin.php?page=adrotate-groups">
	...
	<input type="hidden" name="adrotate_action" value="<?php echo $action;?>" />
   	...
   	<table class="widefat" style="margin-top: .5em">
		...
		<thead>
		<tr>
			<th colspan="4"><?php _e('Automated refresh of adverts (Optional - Ignored if not using Dynamic Mode)', 'adrotate'); ?></th>
		</tr>
		</thead>
			
		<tbody>
	    <tr>
			<th valign="top"><?php _e('Interval', 'adrotate'); ?></strong></th>
			<td>
			...
			<td colspan="2">
		        <p><em><?php _e('Load a new advert in this interval without reloading the page. Default: 6.', 'adrotate'); ?></em></p>
			</td>
		</tr>
		</tbody>
		...
		<thead>
		<tr>
			<th colspan="4"><?php _e('Block shape and border (Optional - Ignored if not using Block Mode)', 'adrotate'); ?></th>
		</tr>
		</thead>
	    ...
	    <tr>
			...
			<td colspan="2">
		        <p><em><?php _e('Make a grid for your ads. Filling in 3 and 2 makes a grid with 2 columns showing a maximum of 6 ads. Default: 2x2.', 'adrotate'); ?></em></p>
			</td>
		</tr>
		</tbody>
	    ...
	    <tr>
			...
			<td colspan="2">
		        <p><em><?php _e('Define the maximum size of the ads in pixels minus margin. Size can be \'auto\' (Not recommended). Default: 125/125.', 'adrotate'); ?></em><br /><em><?php _e('Only used for Dynamic and Block mode.', 'adrotate'); ?></em></p>
			</td>
		</tr>
	    <tr>
			<th valign="top"><?php _e('Advert Margin', 'adrotate'); ?></strong></th>
			<td>
				<label for="adrotate_adpadding"><input tabindex="8" name="adrotate_admargin" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
				</td>
			<td colspan="2">
		        <p><em><?php _e('An invisible border outside the advert in pixels. Default: 1.', 'adrotate'); ?></em><br /><em><?php _e('Only used for Dynamic and Block mode.', 'adrotate'); ?></em></p>
			</td>
		</tr>
	    <tr>
			<th><?php _e('GeoLocation', 'adrotate'); ?></th>
			<td colspan="3">
				<p><?php adrotate_pro_notice(); ?></p>
				<em><?php _e('Target cities or countries with GeoLocation.', 'adrotate'); ?></em>
			</td>
		</tr>
	    <tr>
			...
			<td colspan="3">
				<p><?php adrotate_pro_notice(); ?></p>
				<em><?php _e('Select another group to fall back on when all ads are expired, not in the visitors geographic area or are otherwise unavailable.', 'adrotate'); ?></em>
			</td>
		</tr>
      	<tr>
