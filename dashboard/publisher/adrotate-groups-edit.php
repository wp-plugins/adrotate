...
<form name="editgroup" id="post" method="post" action="admin.php?page=adrotate-groups">
	...
	<p><em><?php _e('Only required if your group is in Dynamic or Block mode.', 'adrotate'); ?></em></p>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td>
		       	<label for="adrotate_adwidth"><select tabindex="5" name="adrotate_adspeed">
	...
	<p class="submit">
		<input tabindex="6" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
	...
	<h3><?php _e('Advanced', 'adrotate'); ?></h3>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td>
				<label for="adrotate_admargin"><input tabindex="7" name="adrotate_admargin" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
				</td>
			<td colspan="2">
		        <p><em><?php _e('A transparent area outside the advert in pixels. Default: 1.', 'adrotate'); ?> <?php _e('Set to 0 to disable.', 'adrotate'); ?></em></p>
			</td>
		</tr>
	    <tr>
			<th valign="top" width="15%"><?php _e('Geo Targeting', 'adrotate'); ?></th>
			<td width="35%"><label for="adrotate_geo"><input tabindex="8" type="checkbox" name="adrotate_geo" value="1" disabled /> <?php _e('Enable GeoTargeting for this group.', 'adrotate'); ?></label></td>
			<td><p><em><?php _e('Do not forget to tell the adverts for which areas they should show.', 'adrotate'); ?></em><br /><em><?php adrotate_pro_notice(); ?></em></p></td>
		</tr>
	    <tr>
			<th valign="top"><?php _e('Fallback group', 'adrotate'); ?></th>
			<td>
				<label for="adrotate_fallback"><select tabindex="9" name="adrotate_fallback" disabled>
		        	<option value="0"><?php _e('No', 'adrotate'); ?></option>
				</select></label>
			</td>
	        <td><em><?php _e('Select another group to fall back on when all ads are expired, not in the visitors geographic area or are otherwise unavailable.', 'adrotate'); ?></em><br /><em><?php adrotate_pro_notice(); ?></em></td>
		</tr>
      	<tr>
	        <th valign="top"><?php _e('Sortorder:', 'adrotate'); ?></th>
	        <td><label for="adrotate_sortorder"><input tabindex="10" name="adrotate_sortorder" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_group->sortorder;?>" /></label></td>
   	...
   	<table class="widefat" style="margin-top: .5em">
      	...
      	<tr>
	        ...
	        <label for="adrotate_page_location">
		        <select tabindex="13" name="adrotate_page_location">
	        ...
	        <label for="adrotate_page_paragraph">
		        <select tabindex="14" name="adrotate_page_paragraph">
	...
	<p class="submit">
		<input tabindex="15" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="16" name="adrotate_wrapper_before" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_before); ?></textarea></td>
			<td width="35%">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="17" name="adrotate_wrapper_after" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_after); ?></textarea></td>
			<td>
	...
	<p class="submit">
		<input tabindex="18" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
