...
?>
		...
		<tbody>
      	...
      	<tr>
	        ...
	        <td>
		        ...
		        <p><em><a href="#" onclick="textatcursor('adrotate_bannercode','%id%');return false;">%id%</a>, <a href="#" onclick="textatcursor('adrotate_bannercode','%image%');return false;">%image%</a>, <a href="#" onclick="textatcursor('adrotate_bannercode','%link%');return false;">%link%</a>, <a href="#" onclick="textatcursor('adrotate_bannercode','target=&quot;_blank&quot;');return false;">target="_blank"</a>, <a href="#" onclick="textatcursor('adrotate_bannercode','rel=&quot;nofollow&quot;');return false;">rel="nofollow"</a></em><br />
		        ...
		        <p>1. <em><a href="#" onclick="textatcursor('adrotate_bannercode','&lt;a href=&quot;%link%&quot;&gt;This ad is great!&lt;/a&gt;');return false;">&lt;a href="%link%"&gt;This ad is great!&lt;/a&gt;</a></em></p>
		        <p>2. <em><a href="#" onclick="textatcursor('adrotate_bannercode','&lt;a href=&quot;%link%&quot;&gt;&lt;img src=&quot;%image%&quot; /&gt;&lt;/a&gt;');return false;">&lt;a href="%link%"&gt;&lt;img src="%image%" /&gt;&lt;/a&gt;</a></em></p>
		        <p>3. <em><a href="#" onclick="textatcursor('adrotate_bannercode','&lt;span class=&quot;ad-%id%&quot;&gt;&lt;a href=&quot;http://example.com&quot;&gt;Text Link Ad!&lt;/a&gt;&lt;/span&gt;');return false;">&lt;span class="ad-%id%"&gt;&lt;a href="http://example.com"&gt;Text Link Ad!&lt;/a&gt;&lt;/span&gt;</a></em></p>
	...
	<p><em><?php _e('This works if you assign the advert to a group and enable that group to use Geo Targeting.', 'adrotate'); ?> (<?php adrotate_pro_notice('t'); ?>)</em></p>
	<table class="widefat" style="margin-top: .5em">			
		<tbody>
	    <tr>
	        ...
	        <td colspan="2">
		        <label for="adrotate_geo_countries">
			        <div class="adrotate-select">
				        <input type="checkbox" name="adrotate_geo_countries[]" value="AF" disabled="disabled">&nbsp;&nbsp;Afghanistan<br>
				        <input type="checkbox" name="adrotate_geo_countries[]" value="AL" disabled="disabled">&nbsp;&nbsp;Albania<br>
				        <input type="checkbox" name="adrotate_geo_countries[]" value="DZ" disabled="disabled">&nbsp;&nbsp;Algeria<br>
				        <input type="checkbox" name="adrotate_geo_countries[]" value="AD" disabled="disabled">&nbsp;&nbsp;Andorra<br>
				        <input type="checkbox" name="adrotate_geo_countries[]" value="AO" disabled="disabled">&nbsp;&nbsp;Angola
			        </div>
		        </label>
	        </td>
			<td>
	...
	<p><em><?php _e('Set a budget for clicks and impressions.', 'adrotate'); ?> (<?php adrotate_pro_notice('t'); ?>)</em></p>
	<table class="widefat" style="margin-top: .5em">	
		<tbody>
      	<tr>
