...
?>
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	...
      	<tr>
	        <th width="20%"><?php _e('Email or Remote page:', 'adrotate'); ?></th>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<?php if($adrotate_config['enable_stats'] == 'Y') { ?>
      	<tr>
	        ...
	        <td colspan="3">
	        	<label for="adrotate_tracker"><input tabindex="4" type="checkbox" name="adrotate_tracker" <?php if($edit_banner->tracker == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Enable click tracking for this advert.', 'adrotate'); ?></label> <label for="adrotate_link"><?php if($edit_banner->link != '') { ?>url: <?php echo $edit_banner->link; } ?><br />
		        <em><?php _e('The URL field is no longer required. Placing the URL in your adcode and enabling click tracking is sufficient.', 'adrotate'); ?></label>
	        </td>
      	</tr>
      	<tr>
	        <th width="15%" valign="top"><?php _e('Remote usage:', 'adrotate'); ?></th>
	        <td colspan="3">
