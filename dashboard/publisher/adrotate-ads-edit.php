...
?>
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	<tr>
	        <th width="10%"><?php _e('Title:', 'adrotate'); ?></th>
	        <td colspan="3">
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	<tr>
	        <th width="20%"><?php _e('In a post or page:', 'adrotate'); ?></th>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<?php if($adrotate_config['enable_stats'] == 'Y') { ?>
      	<tr>
	        <th width="10%" valign="top"><?php _e('Clicktracking:', 'adrotate'); ?></th>
	        <td colspan="3">
	        	<label for="adrotate_tracker"><input tabindex="4" type="checkbox" name="adrotate_tracker" <?php if($edit_banner->tracker == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Enable click tracking for this advert.', 'adrotate'); ?></label> <?php if(!empty($edit_banner->link)) { ?><label for="adrotate_link">url: <input tabindex="5" name="adrotate_link" type="text" size="80" class="search-input" value="<?php echo $edit_banner->link;?>" disabled /><br />
		        <em><?php _e('The URL field is no longer required. Placing the URL in your adcode and enabling click tracking is sufficient.', 'adrotate'); ?></label><?php } ?>
	        </td>
      	</tr>
		<?php } ?>
		<tr>
	...
	<table class="widefat" style="margin-top: .5em">			
		<tbody>
	    <tr>
			<th width="10%" valign="top"><?php _e('Cities:', 'adrotate'); ?></strong></th>
	...
	<table class="widefat" style="margin-top: .5em">	
		<tbody>
      	<tr>
	        <th width="10%" valign="top">Advertiser:</th>
	        <td colspan="3">
