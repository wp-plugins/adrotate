...
wp_enqueue_media();
wp_enqueue_script('uploader-hook', WP_PLUGIN_URL.'/adrotate-pro/library/uploader-hook.js', array('jquery'));
		...
		<tr>
			...
			<td colspan="3">
				<label for="adrotate_image">
					<?php _e('Media:', 'adrotate'); ?> <input tabindex="7" id="adrotate_image" type="text" size="100" name="adrotate_image" value="<?php echo $image_field; ?>" /> <input id="adrotate_image_button" class="button" type="button" value="<?php _e('Select Banner', 'adrotate'); ?>" /><br />
