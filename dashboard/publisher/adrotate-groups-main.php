   	...
   	<table class="widefat" style="margin-top: .5em">
		...
		if($groups) {
			...
			foreach($groups as $group) {
		        ...
		        if($group->modus == 2) $modus[] = __('Block', 'adrotate').' ('.$group->gridcolumns.' x '.$group->gridrows.' '. __('grid', 'adrotate').')';
